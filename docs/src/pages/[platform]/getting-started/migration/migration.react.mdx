...
Migration guides for [`In-App Messaging`](#`@aws-amplify/ui-react-notifications`) and [`Storage`](/getting-started/migration#`@aws-amplify/ui-react-storage`) components can be found towards the bottom of this page.
</Message>
